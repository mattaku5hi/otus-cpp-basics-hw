...
public:
    ...
    private:
        ...
        ContainerCont* m_pContainer;
    public:
        IteratorConst(T* pData, size_t index, ContainerCont* pCont);
        T& operator*() const;
...
template <typename T>
ContainerCont<T>::IteratorConst::IteratorConst(T* pData, size_t index, ContainerCont* pCont) 
    : m_pData(pData), m_index(index), m_pContainer(pCont)
{
...
template <typename T>
T& ContainerCont<T>::IteratorConst::operator*() const
{
    return *(m_pData);
}

template <typename T>
T& ContainerCont<T>::IteratorConst::operator[](std::ptrdiff_t index) const
{
    return m_pData[index];
}
...
template <typename T>
T& ContainerCont<T>::IteratorConst::getValue()
{
    return *m_pData;
}
